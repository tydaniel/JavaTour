package net.tydaniel.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "D://PXJ//JavaTour//P03_SpringMVC_Shiro//generator";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		// 自定义 controller 父类
		 strategy.setSuperControllerClass("net.tydaniel.commons.base.BaseController");
		...
		pc.setParent("net.tydaniel"); // 自定义包路径
